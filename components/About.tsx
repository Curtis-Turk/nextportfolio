    ...
    >
      ...
      <div className="p-10">
        ...
        <p className="text-base">
          ...
          building projects that solve real world problems. <br></br>I&apos;ve
          just completed the Makers academy intensive bootcamp learning the
          value of test-driven, agile development with object oriented design.
          I&apos;m looking to expand my experience in a full stack developer
          role.<br></br>
          Checkout my
          <a
